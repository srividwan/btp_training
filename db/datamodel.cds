...
context transaction {
    entity purchaseorder: common.Amount, cuid{
        ...
        //commenting the keys to auto generate when a purchase order/item is created.
        ...
        //replaced association to with composition of in above statement for draft implementation. 
    }
